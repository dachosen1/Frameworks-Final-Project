...
ggplot(data = city.dat) + geom_bar(stat = 'identity', fill = 'firebrick4', 
 ...
 xlab('City') + ylab('Number of Restaurants')+coord_flip() + theme_wsj()  + 
...
ggplot(data = city.dat) + geom_bar(stat = 'identity', fill = 'firebrick4', 
 ...
 xlab('City') + ylab('Average Price Range')+coord_flip() + theme_wsj()  + 
...
ggplot(data = city.dat) + geom_bar(stat = 'identity', fill = 'firebrick4', 
 ...
 xlab('City') + ylab('Average number of restaurants Reviews')+coord_flip() + theme_wsj()  + 
...
ggplot(data = city.dat) + geom_bar(stat = 'identity', fill = 'firebrick4', 
 ...
 xlab('City') + ylab('Average Ratings')+coord_flip() + theme_wsj() + 
