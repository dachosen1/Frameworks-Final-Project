...
cm.10000.rf <- cm.consolidate(path = 'models/Price Range/cm_Random Forest10000.rda', 
                             Observations = 10000, model = 'Random Forest')

# Combine models 
cm.all <- rbind(cm.1000.mlr, cm.5000.mlr,cm.10000.mlr, cm.1000.rf, cm.5000.rf,cm.10000.rf)
...
accuracy.mlr.1000 <- cm.accurary(path = 'models/Price Range/cm_Multinomial Multinomial Regression1000.rda', 
                                 name = 'LR 1000 Accuracy')
accuracy.mlr.5000 <- cm.accurary(path = 'models/Price Range/cm_Multinomial Multinomial Regression5000.rda',
                                 name = 'LR 5000 Accuracy')
accuracy.mlr.10000 <- cm.accurary(path = 'models/Price Range/cm_Multinomial Multinomial Regression10000.rda',
                                  name = 'LR 10000 Accuracy')

accuracy.rf.1000 <- cm.accurary(path = 'models/Price Range/cm_Random Forest1000.rda',
                                name = 'RF 1000 Accuracy')
accuracy.rf.5000 <- cm.accurary(path = 'models/Price Range/cm_Random Forest5000.rda',
                                name = 'RF 5000 Accuracy')
accuracy.rf.10000 <- cm.accurary(path = 'models/Price Range/cm_Random Forest10000.rda',
                                 name = 'RF 10000 Accuracy')

accuracy.all <- rbind(accuracy.mlr.1000, accuracy.mlr.5000,accuracy.mlr.10000,
                      accuracy.rf.1000,accuracy.rf.5000,accuracy.rf.10000)
